...
const Navbar = ({ mode, handleChange }) => {
  ...
  const navbarClasses = scrolling
    ? "fixed top-0 w-full bg-[#844efe] transition duration-200 "
    : "absolute transition duration-200";
  return (
    <nav
      className={`bg-[#E9E9E9] text-white dark:bg-[#844efe]  font-bold  h-14 md:h-20 w-full min-w-[343px]  flex items-center justify-between md:justify-center  md:py-4 py-2  px-4 md:px-60 mx-auto ${navbarClasses}`}
    >
